...
INSERT INTO `collect_goods` VALUES ('2', '3', null);
INSERT INTO `collect_goods` VALUES ('2', '2', null);
INSERT INTO `collect_goods` VALUES ('2', '1', null);
...
INSERT INTO `collect_pets` VALUES ('2', '4', '秋田犬');
INSERT INTO `collect_pets` VALUES ('2', '5', '边境牧羊犬');
INSERT INTO `collect_pets` VALUES ('2', '11', '大丹犬');
INSERT INTO `collect_pets` VALUES ('2', '15', '布偶猫');
INSERT INTO `collect_pets` VALUES ('3', '1', null);
...
CREATE TABLE `comments_statuses` (
  ...
  `text` text,
  `th_com_pic` varchar(255) DEFAULT NULL,
...
CREATE TABLE `follow` (
  ...
  `by_follower` int(11) DEFAULT NULL,
...
INSERT INTO `follow` VALUES ('31', '9', '2');
INSERT INTO `follow` VALUES ('26', '7', '2');
INSERT INTO `follow` VALUES ('33', '13', '2');
...
CREATE TABLE `goods` (
  ...
  `sname` varchar(255) DEFAULT NULL,
  `multi_pic` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`gid`),
  KEY `sname` (`sname`,`sid`)
...
CREATE TABLE `pet_wiki` (
  ...
  `p_index` varchar(8) DEFAULT NULL,
  PRIMARY KEY (`pid`)
...
CREATE TABLE `pic_goods` (
  ...
  `th_url` varchar(255) DEFAULT NULL,
...
INSERT INTO `sessions` VALUES ('6', 'e5419df5302ad931ad0c7b4446fbebcf', '2017-04-04 14:25:03', '2');
...
INSERT INTO `sessions` VALUES ('9', '731eb56ef8036a33ab883396d01171b0', '2017-04-04 14:25:06', '2');
...
CREATE TABLE `statuses` (
  ...
  `text` text,
  `thumbnail_pic` varchar(255) DEFAULT NULL,
  `pic_urls` varchar(255) DEFAULT NULL COMMENT '图片数据',
  `source` varchar(255) DEFAULT NULL,
  `checked` tinyint(2) DEFAULT NULL,
  `favorite_count` int(11) DEFAULT NULL,
  `is_pic` tinyint(2) DEFAULT NULL,
  PRIMARY KEY (`mid`)
...
INSERT INTO `statuses` VALUES ('10', '2', '2017-01-05 16:31:19', '放在过去，英特尔的“Tick-Tock”蓝图一直是简单清晰的：先是推出Tick处理器，也就是用新的（更小的）制程节点和现有架构推出小幅升级的处理器', null, 'http://wx2.sinaimg.cn/mw690/91e4a538gy1fbvxo716kij20dc0godgg.jpg', 'mobile', null, '65', '1');
INSERT INTO `statuses` VALUES ('11', '8', '2017-01-05 16:31:19', 'Ryzen 7首发三款都是8核16线程，前不久，AMD 公布了Ryzen 5，分别是6核的1600X和4核的1500X', null, 'http://wx2.sinaimg.cn/mw690/91e4a538gy1fbvxo716kij20dc0godgg.jpg', 'firefox', null, '4', '1');
INSERT INTO `statuses` VALUES ('12', '9', '2008-01-05 16:31:19', '此前，AMD 官宣的1600X频率范围3.6-4.0GHz，热设计功耗95W，1500X频率范围3.5-3.7GHz，热设计功耗65W。', null, 'http://wx2.sinaimg.cn/mw690/91e4a538gy1fbvxo716kij20dc0godgg.jpg', 'ie', null, '878', '1');
...
INSERT INTO `statuses` VALUES ('26', '9', '2017-03-17 20:21:00', '两条猫…米奇你这肚子也太突兀了吧', null, null, 'Iphone 7', null, null, null);
INSERT INTO `statuses` VALUES ('27', '9', '2017-03-17 20:29:18', 'pets', null, null, 'Iphone 7', null, null, null);
INSERT INTO `statuses` VALUES ('28', '5', '2017-03-22 21:31:37', '这是一只超爱盯着铲屎官吃饭的喵星人。。', null, null, 'Iphone 7', null, null, null);
INSERT INTO `statuses` VALUES ('29', '4', '2017-03-22 21:51:27', '科技行业的中年危机天花板', '', '', 'Iphone 7', null, null, null);
INSERT INTO `statuses` VALUES ('30', '2', '2017-03-27 22:10:44', '我想对你说什么', null, null, 'Iphone 7', null, null, null);
INSERT INTO `statuses` VALUES ('31', '2', '2017-04-04 18:29:45', '我有一头小毛驴', null, null, 'Iphone 7', null, null, null);
...
CREATE TABLE `store` (
  ...
  `s_icon` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`sid`),
  KEY `sname` (`sname`),
  KEY `sid` (`sid`,`sname`)
...
-- ----------------------------
-- Table structure for store_manage
-- ----------------------------
DROP TABLE IF EXISTS `store_manage`;
...
-- ----------------------------
-- Records of store_manage
-- ----------------------------
INSERT INTO `store_manage` VALUES ('1', '123', '123', '1', null);
...
CREATE TABLE `user` (
  ...
  `account` varchar(255) NOT NULL COMMENT '登陆账户',
  `password` char(255) DEFAULT NULL COMMENT '登陆密码',
  `birthday` date DEFAULT NULL,
  `thumbnail_pic` varchar(255) DEFAULT NULL COMMENT '头像缩略图',
  `profile_image_url` varchar(255) DEFAULT NULL COMMENT '用户头像',
  `user_description` text COMMENT '用户描述',
  `created_date` date DEFAULT NULL COMMENT '创建日期',
  `location` varchar(255) DEFAULT NULL,
  `verified_type` tinyint(4) DEFAULT NULL COMMENT '是否认证',
...
INSERT INTO `user` VALUES ('6', '一个老司机', 'woman', '15518153496', '123', '2009-03-19', 'http://wx2.sinaimg.cn/mw690/6b7c5633ly1fdpnsj458qj20h80cxwf6.jpg', 'http://wx2.sinaimg.cn/mw690/6b7c5633ly1fdpnsj458qj20h80cxwf6.jpg', '开车开车', '2017-03-01', null, '5', '3');
...
INSERT INTO `user` VALUES ('9', 'DC漫改', 'woman', 'dc', '123', '2010-03-19', 'http://wx4.sinaimg.cn/mw690/6b7c5633ly1fdpm9ox6wmj20sg0f8mzz.jpg', 'http://wx4.sinaimg.cn/mw690/6b7c5633ly1fdpm9ox6wmj20sg0f8mzz.jpg', '这是朕为你打下的江山', '2017-03-17', null, '3', '3');
INSERT INTO `user` VALUES ('10', '大奔是你吗', 'woman', 'daben', '123', '2011-03-19', 'http://wx2.sinaimg.cn/mw690/0067kl0kgy1fdplua9rh1j30y90ja4hu.jpg', 'http://wx2.sinaimg.cn/mw690/0067kl0kgy1fdplua9rh1j30y90ja4hu.jpg', '假面二猫', '2017-03-17', null, '3', '3');
...
INSERT INTO `user` VALUES ('23', 'query', 'woman', '12', '1234', null, null, null, '', '2017-04-02', null, null, null);
